...
#
## TO DO ##
# Add thre "contacts make script" to this so that you can opt to send
# a set msg to all numbers in the phone book that are 10-11 numbers
#
# will need to make a "cleanup" function as there will be contacts list
# left over from read file.
